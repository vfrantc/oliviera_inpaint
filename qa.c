...
__PYX_EXTERN_C DL_IMPORT(double) c_psnr(unsigned char *, unsigned char *, int, int); /*proto*/
...
static PyObject *__pyx_pf_2qa_psnr(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_orig, PyArrayObject *__pyx_v_distorted); /* proto */
...
static char __pyx_k_home_franz_devel_oliviera_inpai[] = "/home/franz/devel/oliviera_inpaint/qa.pyx";
...
static PyObject *__pyx_n_s_distorted;
static PyObject *__pyx_kp_s_home_franz_devel_oliviera_inpai;
...
static PyObject *__pyx_n_s_psnr;
...
/* Python wrapper */
static PyObject *__pyx_pw_2qa_1psnr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_2qa_1psnr = {"psnr", (PyCFunction)__pyx_pw_2qa_1psnr, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_2qa_1psnr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_orig = 0;
  PyArrayObject *__pyx_v_distorted = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("psnr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_orig,&__pyx_n_s_distorted,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_distorted)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("psnr", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "psnr") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_distorted = ((PyArrayObject *)values[1]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("psnr", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("qa.psnr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_orig), __pyx_ptype_5numpy_ndarray, 0, "orig", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_distorted), __pyx_ptype_5numpy_ndarray, 1, "distorted", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_2qa_psnr(__pyx_self, __pyx_v_orig, __pyx_v_distorted);
...
static PyObject *__pyx_pf_2qa_psnr(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_orig, PyArrayObject *__pyx_v_distorted) {
  int __pyx_v_m;
  int __pyx_v_n;
  double __pyx_v_result;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_distorted;
  __Pyx_Buffer __pyx_pybuffer_distorted;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_orig;
  __Pyx_Buffer __pyx_pybuffer_orig;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("psnr", 0);
  __pyx_pybuffer_orig.pybuffer.buf = NULL;
  __pyx_pybuffer_orig.refcount = 0;
  __pyx_pybuffernd_orig.data = NULL;
  __pyx_pybuffernd_orig.rcbuffer = &__pyx_pybuffer_orig;
  __pyx_pybuffer_distorted.pybuffer.buf = NULL;
  __pyx_pybuffer_distorted.refcount = 0;
  __pyx_pybuffernd_distorted.data = NULL;
  __pyx_pybuffernd_distorted.rcbuffer = &__pyx_pybuffer_distorted;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_orig.rcbuffer->pybuffer, (PyObject*)__pyx_v_orig, &__Pyx_TypeInfo_unsigned_char, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_orig.diminfo[0].strides = __pyx_pybuffernd_orig.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_orig.diminfo[0].shape = __pyx_pybuffernd_orig.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_orig.diminfo[1].strides = __pyx_pybuffernd_orig.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_orig.diminfo[1].shape = __pyx_pybuffernd_orig.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_distorted.rcbuffer->pybuffer, (PyObject*)__pyx_v_distorted, &__Pyx_TypeInfo_unsigned_char, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_distorted.diminfo[0].strides = __pyx_pybuffernd_distorted.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_distorted.diminfo[0].shape = __pyx_pybuffernd_distorted.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_distorted.diminfo[1].strides = __pyx_pybuffernd_distorted.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_distorted.diminfo[1].shape = __pyx_pybuffernd_distorted.rcbuffer->pybuffer.shape[1];
 ...
 *     return result
 */
  __pyx_t_1 = (__pyx_v_orig->dimensions[0]);
  __pyx_t_2 = (__pyx_v_orig->dimensions[1]);
  __pyx_v_m = __pyx_t_1;
  __pyx_v_n = __pyx_t_2;
 ...
 */
  ...
  __pyx_t_5 = 0;
  __pyx_t_6 = 0;
  __pyx_v_result = c_psnr((&(*__Pyx_BufPtrCContig2d(unsigned char *, __pyx_pybuffernd_orig.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_orig.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_orig.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig2d(unsigned char *, __pyx_pybuffernd_distorted.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_distorted.diminfo[0].strides, __pyx_t_6, __pyx_pybuffernd_distorted.diminfo[1].strides))), __pyx_v_m, __pyx_v_n);
 ...
 */
  ...
  __pyx_t_7 = PyFloat_FromDouble(__pyx_v_result); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_distorted.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_orig.rcbuffer->pybuffer);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_distorted, __pyx_k_distorted, sizeof(__pyx_k_distorted), 0, 0, 1, 1},
  {&__pyx_kp_s_home_franz_devel_oliviera_inpai, __pyx_k_home_franz_devel_oliviera_inpai, sizeof(__pyx_k_home_franz_devel_oliviera_inpai), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_psnr, __pyx_k_psnr, sizeof(__pyx_k_psnr), 0, 0, 1, 1},
 ...
 *     cdef double result
 */
  __pyx_tuple__7 = PyTuple_Pack(5, __pyx_n_s_orig, __pyx_n_s_distorted, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_result); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_franz_devel_oliviera_inpai, __pyx_n_s_psnr, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initqa(void); /*proto*/
PyMODINIT_FUNC initqa(void)
#else
PyMODINIT_FUNC PyInit_qa(void); /*proto*/
PyMODINIT_FUNC PyInit_qa(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_qa(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "qa")) {
      if (unlikely(PyDict_SetItemString(modules, "qa", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef double result
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_2qa_1psnr, NULL, __pyx_n_s_qa); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_psnr, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
